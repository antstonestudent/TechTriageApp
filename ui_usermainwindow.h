...
public:
    ...
    QLabel *label_6;
    QPushButton *newTicketButton;
    QPushButton *yourTicketsButton;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget_2->setGeometry(QRect(10, 0, 561, 101));
        ...
        plainTextEdit->setGeometry(QRect(250, 10, 331, 64));
        QFont font;
        ...
        label_6->setGeometry(QRect(770, 130, 821, 331));
        label_6->setPixmap(QPixmap(QString::fromUtf8(":/imge/imge/welcomeback.png")));
        label_6->setScaledContents(true);
        newTicketButton = new QPushButton(widget);
        newTicketButton->setObjectName("newTicketButton");
        newTicketButton->setGeometry(QRect(510, 550, 441, 321));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/imge/imge/New Ticket Req.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        newTicketButton->setIcon(icon5);
        newTicketButton->setIconSize(QSize(500, 500));
        yourTicketsButton = new QPushButton(widget);
        yourTicketsButton->setObjectName("yourTicketsButton");
        yourTicketsButton->setGeometry(QRect(1330, 450, 671, 500));
        yourTicketsButton->setMinimumSize(QSize(400, 400));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/imge/imge/Ticket Status.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        yourTicketsButton->setIcon(icon6);
        yourTicketsButton->setIconSize(QSize(500, 600));
        inboxButton = new QPushButton(widget);
        inboxButton->setObjectName("inboxButton");
        inboxButton->setGeometry(QRect(1040, 580, 321, 221));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/imge/imge/inbox.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        inboxButton->setIcon(icon7);
        inboxButton->setIconSize(QSize(400, 400));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        plainTextEdit->setPlainText(QCoreApplication::translate("MainWindow", "DASHBOARD", nullptr));
        ...
        newTicketButton->setText(QString());
        yourTicketsButton->setText(QString());
