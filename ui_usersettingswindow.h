...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget_2->setGeometry(QRect(10, 0, 491, 101));
        ...
        plainTextEdit->setGeometry(QRect(250, 20, 251, 81));
        QFont font;
        ...
        label_6->setGeometry(QRect(890, 270, 341, 591));
        label_6->setPixmap(QPixmap(QString::fromUtf8(":/imge/imge/Settings list.png")));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        plainTextEdit->setPlainText(QCoreApplication::translate("MainWindow", "SETTINGS", nullptr));
